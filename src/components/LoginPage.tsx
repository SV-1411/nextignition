      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 lg:px-8 py-4">
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm text-gray-600 pt-[0px] pr-[0px] pb-[0px] pl-[5px]">Don't have an account?</span>
            <a
              href="#signup"
              className="px-5 py-2 text-sm font-medium rounded-full transition-colors text-white flex-shrink-0"
              style={{ backgroundColor: brandColors.atomicOrange }}
            >
              Sign Up
            </a>
              ...
              >
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <motion.button
                    ...
                    className={`w-full py-4 rounded-xl font-bold text-white shadow-lg hover:shadow-xl transition-all group flex items-center justify-center gap-2 ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                    style={{
